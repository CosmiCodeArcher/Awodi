...
function Footer({ onSectionChange }) {
    ...
    return (
        <footer className="mt-auto p-4 md:p-6 bg-white/5 backdrop-blur-sm">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    ...
                    <div className="text-center md:text-left">
                        <img 
                            src="/Awodi.png" 
                            alt="Awodi Logo" 
                            className="w-16 h-auto object-contain mx-auto md:mx-0 mb-2"
                        />
                    ...
                    <div className="text-center">
                        <nav className="space-x-4 md:space-x-6">
                            <button 
                                ...
                                className="text-sm hover:text-modern-coral transition-colors duration-300"
                            >
                                Portfolio
                            </button>
                            <button 
                    ...
                    <div className="text-center md:text-right">
                        <div className="flex justify-center md:justify-end space-x-4 mb-2">
                            <a 
                                ...
                                className="hover:text-modern-coral transition-colors duration-300"
                                aria-label="GitHub"
                            >
